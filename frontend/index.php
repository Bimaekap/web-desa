                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="news-detail.html">Visi & Misi</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">Sejarah Desa</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">Geografis Desa</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">Demografi Desa</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link click-scroll dropdown-toggle" href="#section_5"
                            id="navbarLightDropdownMenuLink" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">Pemerintahan</a>
                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                            <li><a class="dropdown-item" href="news.html">Struktur Organisasi</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">Perangkat Desa</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">Lembaga Desa</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link click-scroll dropdown-toggle" href="#section_5"
                        ...
                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="news-detail.html">Pengumuman</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">Agenda</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">Galeri</a></li>
                            <li><a class="dropdown-item" href="news-detail.html">APBDesa</a></li>
                        </ul>
                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-text-box">
                            <h2 class="mb-2">Foto Kepala Desa</h2>
